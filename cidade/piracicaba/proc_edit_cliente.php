...
$result_cadastro = "UPDATE cliente SET nome='$nome', nempresa='$nempresa', cpf='$cpf', email='$email', site='$site', 
contato='$contato', endereco='$endereco', cidade='$cidade', estado='$estado', categoria='$categoria', 
classificacao='$classificacao', imagem_cartao='$imagem_cartao' WHERE id=$id";
