...
if (!empty($_SESSION['id'])) {
  ?>
    <li class="nav-item dropdown prof_picture_nav">
        <div class="dropdown-menu options_menu" aria-labelledby="navbarDropdownMenuLink">
          <p class="dropdown-item"><i class="fa-solid fa-user"></i><?php echo $_SESSION['nome'];?></p>
          <a class="dropdown-item" href='edit_cliente.php?id="<?php echo $_SESSION['id'] ?>"'><i class="fa-regular fa-pen-to-square"></i>Editar</a>
          <a class="dropdown-item" href="#"><i class="fa-solid fa-circle-half-stroke"></i>Tema</a>
          <a class="dropdown-item" href="sair.php"><i class="fa-solid fa-right-from-bracket"></i>Sair</a>
        </div>
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="imagens/profile-pic-alt.png" ></a>
    </li>
    <?php
}
?>
